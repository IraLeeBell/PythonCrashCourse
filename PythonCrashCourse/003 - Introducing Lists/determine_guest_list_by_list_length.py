...
# Use len to determine the guest list length
print("\n")
number_of_guests = len(dinner_guests)
number_of_guests_including_me = len(dinner_guests) + 1
print(f"It turns out that there will be {number_of_guests_including_me} guests at dinner, including myself.")
print(f"However, the total number of guests not including me is {number_of_guests}")